...
@AndroidEntryPoint
class CommunityFragment(private val currentUser: User,private  val data:List<Message>) : Fragment(),ChatRecyclerAdapter.OnItemClicked {
    ...
    override fun onCreateView(
        ...
        val adapter =ChatRecyclerAdapter(this,data,currentUser)
